...
const speakers = [
  ...
  {
    name: 'Kilnam Chon',
    image: "<img src='images/sfour.png' alt='image of Kilnam'/>",
  ...
  {
    name: 'Julia Leda',
    image: '<img src="images/sfive.png" alt="image of Julia Leda"/>',
  ...
  {
    name: 'Ryan Merkley',
    image: '<img src= "images/ssix.png" alt= "image of Ryan Merkley"/>',
...
function speaker() {
  ...
  container2.innerHTML += "<button class='more'>MORE <img src='images/down.png' alt='see more button'/></button>";
}
speaker();
